...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "group relative h-full w-[200px] md:w-[400px] cursor-pointer overflow-hidden rounded-3xl border p-4 md:p-5 transition-all duration-500",
        ...
        <div className="flex flex-col items-center gap-3 md:gap-4 w-full">
          ...
          <div className="flex flex-col gap-2 md:gap-2.5 w-full">
            ...
            <Button
              onClick={() => onForm(id)}
              variant="outline"
              className="cursor-pointer w-full border-gray-200 hover:bg-gray-50 hover:border-blue-400 hover:text-blue-600 rounded-xl py-5 md:py-6 transition-all duration-300"
            >
...
export default function HeroSection() {
  ...
  return (
    <div
      id="hero"
      className="relative flex w-full flex-col items-center justify-center overflow-hidden py-24 px-4 bg-white"
    >
      ...
      <div className="relative mx-auto max-w-5xl text-center">
        <h1 className="block w-full bg-gradient-to-b from-gray-900 to-gray-600 bg-clip-text font-bold text-transparent text-4xl md:text-6xl tracking-tight text-center mb-6 leading-[1.1]">
        ...
        <p className="mx-auto my-4 w-full max-w-xl bg-transparent text-center font-medium leading-relaxed tracking-wide text-gray-500 mb-12">
